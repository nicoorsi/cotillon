...
class Proveedores extends CI_Controller
{
  ...
  public function crear() {
    ...
    if ( $this->form_validation->run() === FALSE ) {
      ...
      log_message('info', 'El usuario `'.$this->session->userdata('usuario').'` <ID:'.$this->session->userdata('id_usuario').'> agregro un nuevo proveedor `'. $this->input->post('nombre') .'`.');
  ...
  public function actualizar( $id )
  {
    if ( ! $this->session->userdata('esta_logeado') ) {
      ...
      $this->load->view('includes/footer');
        ...
        log_message('info', 'El usuario `'.$this->session->userdata('usuario').'` <ID:'.$this->session->userdata('id_usuario').'> Actualizo un proveedor `'. $this->input->post('nombre') .'`.');
