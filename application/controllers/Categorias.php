    ...
    public function crear(){
      if ( ! $this->session->userdata('esta_logeado') && $this->session->userdata('es_admin') ) {
        ...
        if ( $this->form_validation->run() === FALSE ) {
          ...
          log_message('info', 'El usuario `'.$this->session->userdata('usuario').'` <ID:'.$this->session->userdata('id_usuario').'> creo un nuevo producto `'. $this->input->post('nombre') .'`.');
    ...
    public function actualizar( $id ) {
      if ( ! $this->session->userdata('esta_logeado') && $this->session->userdata('es_admin') ) {
        ...
        if ( $this->form_validation->run() === FALSE ) {
          ...
          log_message('info', 'El usuario `'.$this->session->userdata('usuario').'` <ID:'.$this->session->userdata('id_usuario').'> a actualizado una categoria `'. $this->input->post('nombre') .'`.');
